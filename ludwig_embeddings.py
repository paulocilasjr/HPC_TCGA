...
def get_names(zip_file, file_list):
...
def main(zip_file,
    ...
    sample_names = get_names(zip_file, file_list)

    list_embeddings = extract_embeddings(
        model_name, apply_normalization, output_dir, file_list, transform_type, sample_names)
